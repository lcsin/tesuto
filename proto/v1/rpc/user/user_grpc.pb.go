...
const (
	...
	User_UpdateUserPasswd_FullMethodName = "/user.User/UpdateUserPasswd"
)
...
type UserClient interface {
	...
	// 修改用户信息
	UpdateUserInfo(ctx context.Context, in *UpdateUserInfoReq, opts ...grpc.CallOption) (*common.Empty, error)
	// 修改用户密码
	UpdateUserPasswd(ctx context.Context, in *UpdateUserPasswdReq, opts ...grpc.CallOption) (*common.Empty, error)
}
...
func (c *userClient) Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*common.Empty, error) {
...
func (c *userClient) UpdateUserInfo(ctx context.Context, in *UpdateUserInfoReq, opts ...grpc.CallOption) (*common.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Empty)
...
func (c *userClient) UpdateUserPasswd(ctx context.Context, in *UpdateUserPasswdReq, opts ...grpc.CallOption) (*common.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Empty)
	err := c.cc.Invoke(ctx, User_UpdateUserPasswd_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	// 修改用户信息
	UpdateUserInfo(context.Context, *UpdateUserInfoReq) (*common.Empty, error)
	// 修改用户密码
	UpdateUserPasswd(context.Context, *UpdateUserPasswdReq) (*common.Empty, error)
...
func (UnimplementedUserServer) Register(context.Context, *RegisterReq) (*common.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedUserServer) Login(context.Context, *LoginReq) (*LoginRep, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Login not implemented")
}
func (UnimplementedUserServer) UpdateUserInfo(context.Context, *UpdateUserInfoReq) (*common.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateUserInfo not implemented")
}
func (UnimplementedUserServer) UpdateUserPasswd(context.Context, *UpdateUserPasswdReq) (*common.Empty, error) {
